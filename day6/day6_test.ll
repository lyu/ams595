; ModuleID = 'day6_test.cpp'
source_filename = "day6_test.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_day6_test.cpp, i8* null }]
...
define dso_local void @_Z3fooPii(i32*, i32) #4 {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @_Z3barPii(i32*, i32) #4 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z3fooPii(i32* %7, i32 %8)
  %9 = load i32, i32* %1, align 4
  %10 = call i32 @_Z3barPii(i32* %7, i32 %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_day6_test.cpp() #0 section ".text.startup" {
